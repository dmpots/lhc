...
#ifdef __GLASGOW_HASKELL__
    {-# INLINE unsafeAt #-}
    unsafeAt (UArray _ _ _ arr#) (I# i#) = indexWord8Array# arr# i# `neWord#` 0##
#endif
#ifdef __HUGS__
...
instance MArray (STUArray s) Bool (ST s) where
    ...
    unsafeRead (STUArray _ _ _ marr#) (I# i#) = ST $ \s1# ->
        ...
        (# s2#, e# `neWord#` 0## #) }
    {-# INLINE unsafeWrite #-}
    unsafeWrite (STUArray _ _ _ marr#) (I# i#) b = ST $ \s1# ->
        case writeWord8Array# marr# i# (if b then 1## else 0##) s1# of { s2# ->
        (# s2#, () #) }
...
bOOL_WORD_SCALE n# = bOOL_INDEX (n# +# last#)
  where I# last# = SIZEOF_HSWORD * 8 - 1
-}
wORD_SCALE   n# = scale# *# n# where I# scale# = WORD_SIZE
