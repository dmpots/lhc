...
readInt64OffPtr (Ptr a) (I# i)
  = error "readInt64OffPtr" -- IO $ \s -> case readInt64OffAddr# a i s     of (# s2, x #) -> (# s2, I64# x #)
readWord64OffPtr (Ptr a) (I# i)
  = error "readWord64OffPtr" -- IO $ \s -> case readWord64OffAddr# a i s    of (# s2, x #) -> (# s2, W64# x #)
...
writeInt64OffPtr (Ptr a) (I# i) (I64# x)
  = error "writeInt64OffPtr" -- IO $ \s -> case writeInt64OffAddr# a i x s     of s2 -> (# s2, () #)
writeWord64OffPtr (Ptr a) (I# i) (W64# x)
  = error "writeWord64OffPtr" -- IO $ \s -> case writeWord64OffAddr# a i x s    of s2 -> (# s2, () #)
